...
protected:
   ...
   *
   * @param param_name The name of the parameter that contains the name of the MeshGenerator
   * @return The CSGBase object generated by that MeshGenerator
   */
  [[nodiscard]] std::unique_ptr<CSG::CSGBase> & getCSGMesh(const std::string & param_name);

  /**
   * Like \p getCSGMesh(), but takes the name of another MeshGenerator directly.
   *
   * NOTE: You MUST catch this by reference!
   *
   * @return The Mesh generated by that MeshGenerator
  ...
  getCSGMeshByName(const MeshGeneratorName & mesh_generator_name);
